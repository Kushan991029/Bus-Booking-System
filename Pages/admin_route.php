                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;color: black;">
                                        <form action="../PHP/route_delete.php" method="POST">
                                    ...
                                    <div class="modal-dialog m-width">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="m-header">Update The Route</h5>
                ...
                <div class="modal fade" id="myModal" role="dialog">
                    <div class="modal-dialog m-width">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="../PHP/route.php" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="route_num">Route Number</label>
                                        <input type="text" name='route_num' id="route_num" class="form-control"
                                            placeholder="Enter Route Number" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="from_city">From</label>
                                        <select name="from_city" id="from_city" class="form-control custom-select">
                                    ...
                                    <div class="form-group">
                                        <label for="to_city">To</label>
                                        <select name="to_city" id="to_city" class="form-control custom-select">
                                            <option selected>Select A City</option>
                                            <option>Colombo</option>
                                            <option>Gampaha</option>
                                            <option>Kaluthara</option>
