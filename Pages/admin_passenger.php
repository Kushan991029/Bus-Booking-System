...
include '../PHP/passenger_read.php';
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="font-size: 15px; text-align: left;font-weight: bold;color: black;">First
                                        
                                    </th>
                                    <th style="font-size: 15px; text-align: left;font-weight: bold;color: black;">last
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;color: black;">
                                        <form action="../PHP/passenger_delete.php" method="POST">
                                            <input type="hidden" class="form-control" name="del_id"
                                                 value="<?php echo $rows['id']; ?>" required>
                                            <button type="submit" name="delete_passenger" class="btn btn-danger btn-sm"
