        ...
        <section id="tickets" class="about section-bg">
            <div class="container" data-aos="fade-up" style="width: 80%;">
                ...
                <div class="section-title">
                    ...
                    <h3>Find Out Your Bus <span>Current Reservations</span></h3>
                </div>
                ...
                $sql = "SELECT customer_name,seat_val,mobile_no,booked_seats.bus_no,date_val,trip_no,booked_seats.id FROM booked_seats join buses on booked_seats.bus_no=buses.bus_no where owner_id='$email' ORDER BY booked_seats.id DESC";
                ...
                ?>
                    ...
                    <div class="ticket-new">
                        <div
                            style="border: 2px solid <?php echo $color; ?>;width: 110px;border-radius: 20px;height: 30px;margin-bottom:20px;">
